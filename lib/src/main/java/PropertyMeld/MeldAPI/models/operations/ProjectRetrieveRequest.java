...
public class ProjectRetrieveRequest {
    ...
    public ProjectRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public ProjectRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public ProjectRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
