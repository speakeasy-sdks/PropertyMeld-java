...
public class VendorListRequest {
    ...
    public VendorListRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public VendorListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public VendorListRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public VendorListRequest withOrdering(String ordering) {
        this.ordering = ordering;
        return this;
    }
    
    public VendorListRequest(@JsonProperty("X-Pm-Org") Long xPmOrg) {
        this.xPmOrg = xPmOrg;
  }
}
