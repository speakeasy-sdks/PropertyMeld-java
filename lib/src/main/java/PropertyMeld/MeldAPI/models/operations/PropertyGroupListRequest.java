...
public class PropertyGroupListRequest {
    /**
    ...
    public PropertyGroupListRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public PropertyGroupListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public PropertyGroupListRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public PropertyGroupListRequest withOrdering(String ordering) {
        this.ordering = ordering;
        return this;
    }
    
    public PropertyGroupListRequest(@JsonProperty("X-Pm-Org") Long xPmOrg) {
        this.xPmOrg = xPmOrg;
  }
}
