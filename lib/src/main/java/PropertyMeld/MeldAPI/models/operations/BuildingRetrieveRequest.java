...
public class BuildingRetrieveRequest {
    /**
    ...
    public BuildingRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public BuildingRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public BuildingRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
