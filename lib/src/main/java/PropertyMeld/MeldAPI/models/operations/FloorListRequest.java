...
public class FloorListRequest {
    ...
    public FloorListRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public FloorListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public FloorListRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public FloorListRequest withOrdering(String ordering) {
        this.ordering = ordering;
        return this;
    }
    
    public FloorListRequest(@JsonProperty("X-Pm-Org") Long xPmOrg) {
        this.xPmOrg = xPmOrg;
  }
}
