...
public class InvoiceRetrieveRequest {
    /**
    ...
    public InvoiceRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public InvoiceRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public InvoiceRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
