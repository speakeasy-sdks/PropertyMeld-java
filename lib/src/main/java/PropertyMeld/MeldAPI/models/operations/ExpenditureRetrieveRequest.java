...
public class ExpenditureRetrieveRequest {
    /**
    ...
    public ExpenditureRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public ExpenditureRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public ExpenditureRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
