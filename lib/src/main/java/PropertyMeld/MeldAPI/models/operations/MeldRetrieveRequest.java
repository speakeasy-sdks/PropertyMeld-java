...
public class MeldRetrieveRequest {
    /**
    ...
    public MeldRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public MeldRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public MeldRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
