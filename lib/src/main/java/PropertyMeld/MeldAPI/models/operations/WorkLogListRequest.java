...
public class WorkLogListRequest {
    /**
    ...
    public WorkLogListRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public WorkLogListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public WorkLogListRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public WorkLogListRequest withOrdering(String ordering) {
        this.ordering = ordering;
        return this;
    }
    
    public WorkLogListRequest(@JsonProperty("X-Pm-Org") Long xPmOrg) {
        this.xPmOrg = xPmOrg;
  }
}
