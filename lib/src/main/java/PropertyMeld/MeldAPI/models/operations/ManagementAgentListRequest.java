...
public class ManagementAgentListRequest {
    /**
    ...
    public ManagementAgentListRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public ManagementAgentListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ManagementAgentListRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ManagementAgentListRequest withOrdering(String ordering) {
        this.ordering = ordering;
        return this;
    }
    
    public ManagementAgentListRequest(@JsonProperty("X-Pm-Org") Long xPmOrg) {
        this.xPmOrg = xPmOrg;
  }
}
