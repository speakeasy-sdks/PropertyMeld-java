...
public class FloorRetrieveRequest {
    /**
    ...
    public FloorRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public FloorRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public FloorRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
