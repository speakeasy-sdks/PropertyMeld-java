...
public class Address {
    ...
    public Address withCountyProvince(String countyProvince) {
    ...
    public Address(@JsonProperty("city") String city, @JsonProperty("county_province") String countyProvince, @JsonProperty("line_1") String line1, @JsonProperty("postcode") String postcode) {
        this.city = city;
        this.countyProvince = countyProvince;
        this.line1 = line1;
        this.postcode = postcode;
