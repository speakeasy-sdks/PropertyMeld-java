...
public class ManagementAgentRetrieveRequest {
    /**
    ...
    public ManagementAgentRetrieveRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public ManagementAgentRetrieveRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public ManagementAgentRetrieveRequest(@JsonProperty("X-Pm-Org") Long xPmOrg, @JsonProperty("id") String id) {
        this.xPmOrg = xPmOrg;
        this.id = id;
  }
}
