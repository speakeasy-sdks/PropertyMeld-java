...
public class ResidentFileListRequest {
    /**
    ...
    public ResidentFileListRequest withXPmOrg(Long xPmOrg) {
        this.xPmOrg = xPmOrg;
        return this;
    }
    ...
    public ResidentFileListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ResidentFileListRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ResidentFileListRequest withOrdering(String ordering) {
        this.ordering = ordering;
        return this;
    }
    
    public ResidentFileListRequest(@JsonProperty("X-Pm-Org") Long xPmOrg) {
        this.xPmOrg = xPmOrg;
  }
}
